 ...
 *
 * The Universe keeps track of all the creatures and their locations,
 * including the players, and whether the players are logged in or not.
 */
public class Universe implements Serializable
{

	/**
	 * A list of all the players that are logged in. Every time that the Universe is
	 * reloaded from a file, this should be empty.
	 */
	 ...
	 *
	 * Also, the logged-out players are still sort-of part of the Universe, even if they
	...
	/**
	 * The single Universe! It will be null when the universe is not yet created.
	 * This is perhaps what our universe may have been -- a null reference.
	 */
	...
	/**
	 * Return a list of all players that are registered in the Universe, either logged in or not.
	 *
	...
	/**
	 * Adds a player to the list of logged-in players in the Universe.
	 * Tell the server that a user is now logged in. The Universe can now
	 * find a rightful place for the user.
	 *
	 * If the Player was not previously in the list of players on the
	 * server, it will now be added and put into the starting room.
	 *
	 * @param player
	 *            to add
	 */
	...
	/**
	 * Register a new Player. Add them to the list of Players and assign them
	 * a location, but do not yet
	 *
	 * @param player
	 *            to add
	 */
	 ...
	 *
	 * This removes the player from the world, but it doesn't lose track
	 * of the player's location. It does not delete a Player from the
	 * list of Players in the Universe.
	 *
	 * @param player
	 *            to remove
	 */
