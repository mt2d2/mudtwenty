...
public class ResponseFactory {
	...
	public static ServerResponse getResponse(String text)
	{
		...
		{
			case EXIT:
			case QUIT: return new QuitResponse();
			case HELP:
			case COMMANDS: return new CommandsResponse();
			case WHO: return new WhoResponse();
			case TELL: return new TellResponse();
			case OOC: return new OocResponse();
			case SAY: return new SayResponse();
			case DROP: return new DropResponse();
			case USE: return new UseResponse();
			case L:
			case LS:
			case LOOK: return new LookResponse();
			...
			case N:
			case NORTH: return new MoveResponse(Direction.NORTH);
			case S:
			case SOUTH: return new MoveResponse(Direction.SOUTH);
			case E:
			case EAST: return new MoveResponse(Direction.EAST);
			case W:
			case WEST: return new MoveResponse(Direction.WEST);
